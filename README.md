...
Сервис для синхронизации постов из Instagram Graph API и управления комментариями. Поддерживает асинхронную загрузку данных через Celery и работу в Docker-контейнерах.
